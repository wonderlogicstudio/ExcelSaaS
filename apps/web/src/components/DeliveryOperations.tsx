...
type Limits={cleanup_requires_active_instance?:boolean;input_ttl_seconds:number;order_ttl_seconds:number;cleanup_interval_seconds:number;max_execution_attempts:number;purchase_enabled:boolean;durable_commerce_storage:boolean;support_intake_enabled:boolean;automation_mode:string};
