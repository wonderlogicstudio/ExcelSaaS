...
import sys,json
R=Path("C:/Users/JinwonLee/project/ExcelSaaS");sys.path.insert(0,str(R/'apps/api'))
...
out=Path('C:/Users/JinwonLee/project/DigitalTwin/.tmp/workbookcare-flow01/compatibility');out.mkdir(parents=True,exist_ok=True)
