...
BASE = R / "artifacts/verification/d08-hosted/image"
O = R / "artifacts/verification/d08-complex/image"
...
assert (
    sha(manifest_bytes)
    == "sha256:e6132fcdf49617331ffc9337c2903732999d6ce9facf4ee45558c1a9d782173b"
)
...
changed = {
    ...
    "apps/api/app/comparison_synthetic_sources.json",
}
...
config["history"].append(
    {
        ...
        "created_by": "Approved D08 frozen complex synthetic registry only",
    }
)
...
result = {
    ...
    "pushed": False,
    "build": "two-file registry overlay on verified immutable private beta image",
}
if args.push:
    ...
    with httpx.Client(
        ...
        response = client.put(
            API + "/manifests/d08-complex-" + sha(new_manifest).split(":")[1][:12],
