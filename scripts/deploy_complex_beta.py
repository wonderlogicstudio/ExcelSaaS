...
O = R / "artifacts/verification/d08-complex/release"
...
if phase == "baseline":
    ...
    gw, cfg, spec = gateway()
    v = current_worker()
    assert s["status"]["latestReadyRevisionName"] == "workbookcare-api-beta-00011-bav"
    assert v == "521ad0aa-55f9-4606-b481-fc4861d8a60f"
    assert gw["apiConfig"].endswith("/workbookcare-beta-d08-e6132fcdf496")
    assert any(
        t.get("revisionName") == "workbookcare-api-beta-00011-bav"
